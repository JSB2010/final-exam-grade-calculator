...
export function LmsImportDialog({ onImport, trigger }: LmsImportDialogProps) {
  ...
  const canvasUrl = school === "kent" ? "https://kentdenver.instructure.com" : customUrl
  ...
  const handleImport = async () => {
    try {
      ...
      const res = await fetch(`/api/lms/${provider}`, {
        ...
        body: JSON.stringify({ token, url: canvasUrl }),
      })
        ...
        <div className="py-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              To create a Canvas access token: open <strong>Account &gt; Settings</strong>,
              click <strong>New Access Token</strong>, set a name and expiration,
